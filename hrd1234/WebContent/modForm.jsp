...
<script>
	function frmcheck(){
		...
		if(custname.value==""){
			...
			alert('회원정보가 수정되었습니다.');
			frm.method="post";
			frm.action="${contextPath}/member/modMember.do";
			frm.submit();
		}
...
<body>
	...
	<form name="frm">
		<table>
			<tr>
				<th>회원번호(자동발생)</th>
				<td><input type="text" name="custno" id="custno" value="${member.custno}" readonly="readonly"/></td>
			</tr>
			<tr>	
				<th>
					회원성명
			...
			<tr>
				<td colspan="2">
					<input type="button" value="수정" onclick="frmcheck()"/>
