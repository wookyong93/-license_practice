	...
	<section>
		...
		<table>
			<tr>
				...
				<th width="15%">회원 전화</th>
				<th width="30%">회원 주소</th>
				<th width="15%">가입 일자</th>
				<th width="10%">고객 등급</th>
				<th width="10%">거주 지역</th>
			</tr>
		<c:forEach var="member" items="${memberList}">
			<tr>
				<td><a href="${contextPath}/member/modForm.do?custno=${member.custno}">${member.custno}</a></td>
